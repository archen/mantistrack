...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'photologue.gallery': {
            ...
            'photos': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['photologue.Photo']", 'null': 'True', 'related_name': "'galleries'", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'photologue.photo': {
            ...
            'effect': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['photologue.PhotoEffect']", 'null': 'True', 'related_name': "'photo_related'", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
