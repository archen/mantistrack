...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mantis.container'
        db.add_column('mantises_mantis', 'container',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['containers.Container'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mantis.container'
        db.delete_column('mantises_mantis', 'container_id')
