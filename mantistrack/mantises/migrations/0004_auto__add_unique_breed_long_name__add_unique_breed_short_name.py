...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Breed', fields ['long_name']
        db.create_unique('mantises_breed', ['long_name'])

        # Adding unique constraint on 'Breed', fields ['short_name']
        db.create_unique('mantises_breed', ['short_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Breed', fields ['short_name']
        db.delete_unique('mantises_breed', ['short_name'])

        # Removing unique constraint on 'Breed', fields ['long_name']
        db.delete_unique('mantises_breed', ['long_name'])
    ...
    models = {
        ...
        'photologue.gallery': {
            ...
            'photos': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'null': 'True', 'related_name': "'galleries'", 'symmetrical': 'False', 'to': "orm['photologue.Photo']"}),
        ...
        'photologue.photo': {
            ...
            'effect': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'related_name': "'photo_related'", 'to': "orm['photologue.PhotoEffect']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
