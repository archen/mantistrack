...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mantis.gallery'
        db.add_column('mantises_mantis', 'gallery',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['photologue.Gallery'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mantis.gallery'
        db.delete_column('mantises_mantis', 'gallery_id')
    ...
    models = {
        ...
        'photologue.gallery': {
            ...
            'photos': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'related_name': "'galleries'", 'symmetrical': 'False', 'to': "orm['photologue.Photo']", 'blank': 'True'}),
