...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ContainerType', fields ['name']
        db.create_unique('containers_containertype', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'ContainerType', fields ['name']
        db.delete_unique('containers_containertype', ['name'])
    ...
    models = {
        ...
        'containers.environmentreading': {
            'Meta': {'unique_together': "(('date', 'container'),)", 'object_name': 'EnvironmentReading'},
            'container': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['containers.Container']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {}),
            'humidity': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
